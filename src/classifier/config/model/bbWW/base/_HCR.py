...
from src.classifier.config.setting.bbWWHCR import Input, Output
...
class HCRTrain(KFoldTrain):
    ...
    def initializer(self, splitter: Splitter, **kwargs):
        from src.classifier.ml.models.bbWWHCR import (
            GBNSchedule,
            HCRArch,
            HCRBenchmarks,
            HCRTraining,
...
class HCREval(KFoldEval):
    ...
    def initializer(self, model, splitter, **kwargs):
        from src.classifier.ml.models.bbWWHCR import HCREvaluation
