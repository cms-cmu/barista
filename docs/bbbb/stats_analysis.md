...
python convert_hist_to_json.py -o histos/histAll.json -i ../analysis/output/histAll.coffea
```
...
```
cd coffea4bees/
../shell_combine python3 stats_analysis/make_variable_binning.py -i output/test_/histAll.json -t 10 -o stats_analysis/tmp/histAll_rebinned.root
```
...
for var_type in m4j_zz m4j_zh m4j_hh; do
    ./shell_combine python3 stats_analysis/runTwoStageClosure.py  --var $var_type  \
        ...
        --input_file_data3b analysis/output/sysana/histMixedBkg_data_3b_for_mixed_kfold.root \
        --input_file_TT     analysis/output/sysana/histMixedBkg_TT.root \
        --input_file_mix    analysis/output/sysana/histMixedData.root \
        --input_file_sig    analysis/output/sysana/histSignal_UL.root \
        --use_kfold   
```