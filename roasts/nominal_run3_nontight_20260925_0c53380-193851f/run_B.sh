#!/usr/bin/env bash
# roast nominal_run3_nontight_20260925_0c53380-193851f step B -- generated 2026-09-25 20:25:14
...
EXIT=logs/B.exit
rm -f "$EXIT"
echo "=== roast nominal_run3_nontight_20260925_0c53380-193851f step B start $(date) on $(hostname) ===" | tee -a "$LOG"
...
./run_container snakemake -s coffea4bees/workflows/Snakefile_PhaseB.smk --configfile roasts/nominal_run3_nontight_20260925_0c53380-193851f/config.yml --cores 8 --jobs 8 --printshellcmds --config roast_id=nominal_run3_nontight_20260925_0c53380-193851f 2>&1 | tee -a "$LOG"
RC=${PIPESTATUS[0]}
echo "=== roast nominal_run3_nontight_20260925_0c53380-193851f step B exit $RC $(date) ===" | tee -a "$LOG"
echo "$RC" > "$EXIT"
if [ "$RC" != "0" ]; then
