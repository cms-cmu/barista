#!/usr/bin/env bash
# roast svbfeynnet_run3_20260923_5b01004-31a4b4d step SvBFeynNet_friendtrees_Run3 -- generated 2026-09-23 17:47:47
...
./run_container snakemake -s coffea4bees/workflows/Snakefile_SvBFeynNet_friendtrees_Run3.smk --configfile roasts/svbfeynnet_run3_20260923_5b01004-31a4b4d/config.yml --cores 8 --jobs 8 --printshellcmds --config roast_id=svbfeynnet_run3_20260923_5b01004-31a4b4d --forcerun install_SvBFeynNet_friend_json --unlock || true
./run_container snakemake -s coffea4bees/workflows/Snakefile_SvBFeynNet_friendtrees_Run3.smk --configfile roasts/svbfeynnet_run3_20260923_5b01004-31a4b4d/config.yml --cores 8 --jobs 8 --printshellcmds --config roast_id=svbfeynnet_run3_20260923_5b01004-31a4b4d --forcerun install_SvBFeynNet_friend_json --rerun-incomplete 2>&1 | tee -a "$LOG"
RC=${PIPESTATUS[0]}
