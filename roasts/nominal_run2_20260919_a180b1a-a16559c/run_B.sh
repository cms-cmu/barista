#!/usr/bin/env bash
# roast nominal_run2_20260919_a180b1a-a16559c step B -- generated 2026-09-20 11:01:23
...
./run_container snakemake -s coffea4bees/workflows/Snakefile_PhaseB.smk --configfile roasts/nominal_run2_20260919_a180b1a-a16559c/config.yml --cores 8 --printshellcmds --config roast_id=nominal_run2_20260919_a180b1a-a16559c --unlock || true
./run_container snakemake -s coffea4bees/workflows/Snakefile_PhaseB.smk --configfile roasts/nominal_run2_20260919_a180b1a-a16559c/config.yml --cores 8 --printshellcmds --config roast_id=nominal_run2_20260919_a180b1a-a16559c --rerun-incomplete 2>&1 | tee -a "$LOG"
RC=${PIPESTATUS[0]}
