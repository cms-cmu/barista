...
main() {
cd "$HOME/nobackup/HH4b/prod/mixeddata_run3_20260925_56690d5-1a7e467/barista" || exit 97
LOG=logs/MakeMixedData.log
EXIT=logs/MakeMixedData.exit
rm -f "$EXIT"
echo "=== roast mixeddata_run3_20260925_56690d5-1a7e467 step MakeMixedData start $(date) on $(hostname) ===" | tee -a "$LOG"
