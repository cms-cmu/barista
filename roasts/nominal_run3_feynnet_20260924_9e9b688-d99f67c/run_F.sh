#!/usr/bin/env bash
# roast nominal_run3_feynnet_20260924_9e9b688-d99f67c step F -- generated 2026-09-24 09:05:41
...
main() {
cd "$HOME/nobackup/HH4b/prod/nominal_run3_feynnet_20260924_9e9b688-d99f67c/barista" || exit 97
LOG=logs/F.log
EXIT=logs/F.exit
rm -f "$EXIT"
echo "=== roast nominal_run3_feynnet_20260924_9e9b688-d99f67c step F start $(date) on $(hostname) ===" | tee -a "$LOG"
...
./run_container snakemake -s coffea4bees/workflows/Snakefile_PhaseF.smk --configfile roasts/nominal_run3_feynnet_20260924_9e9b688-d99f67c/config.yml --cores 8 --jobs 8 --printshellcmds --config roast_id=nominal_run3_feynnet_20260924_9e9b688-d99f67c 2>&1 | tee -a "$LOG"
RC=${PIPESTATUS[0]}
echo "=== roast nominal_run3_feynnet_20260924_9e9b688-d99f67c step F exit $RC $(date) ===" | tee -a "$LOG"
echo "$RC" > "$EXIT"
if [ "$RC" != "0" ]; then
